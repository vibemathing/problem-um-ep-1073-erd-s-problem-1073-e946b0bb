...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1073-erd-s-problem-1073-e946b0bb-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1073"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1073-erd-s-problem-1073-e946b0bb-v1",
      "problem_contract_sha256": "ec3571e3e277a7610a159dec3449f6883be2822885334b8de4ca3e9aacd8c02e",
      "problem_id": "problem:um-ep-1073-erd-s-problem-1073-e946b0bb",
      "route_id": "route:um-ep-1073-erd-s-problem-1073-e946b0bb-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1073-erd-s-problem-1073-e946b0bb-source-fidelity-01",
      "graph_id": "graph:um-ep-1073-erd-s-problem-1073-e946b0bb-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1073-erd-s-problem-1073-e946b0bb-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1073-erd-s-problem-1073-e946b0bb-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A(x)$ count the number of composite $u<x$ such that $n!+1\\equiv 0\\pmod{u}$ for some $n$. Is it true that $A(x)\\leq x^{o(1)}$?"
          },
          "statement_sha256": "9806d6214c00c7ff0c2a78fee9f30e390d40d9d69d61ba1f6b1eec05fab60475"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1073-erd-s-problem-1073-e946b0bb-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1073-erd-s-problem-1073-e946b0bb-root",
      "route_id": "route:um-ep-1073-erd-s-problem-1073-e946b0bb-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1073-a99e73345ff7",
        "url": "https://www.unsolvedmath.com/problems/EP-1073"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
